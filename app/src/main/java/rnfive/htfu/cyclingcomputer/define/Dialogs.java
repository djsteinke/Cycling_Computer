...
import rnfive.htfu.cyclingcomputer.define.listeners.IBoolResultListener;
...
public class Dialogs {
    ...
    public static void Confirm(Activity act, ConfirmListener confirmListener, ConfirmType confirmType,
                               String title, @Nullable String desc,
                               String yes, String no, String cancel) {
        AlertDialog dialog = new AlertDialog.Builder(act).create();
        dialog.setTitle(title);
        if (desc != null && !desc.isEmpty())
            dialog.setMessage(Html.fromHtml(desc));
        EditText actName = new EditText(act);
        EditText actDesc = new EditText(act);
        CheckBox cbTrainer = new CheckBox(act);
        CheckBox cbCommute = new CheckBox(act);
        CheckBox cbPrivate = new CheckBox(act);
