...
import rnfive.htfu.cyclingcomputer.define.Preferences;
import rnfive.htfu.cyclingcomputer.define.Strings;
import rnfive.htfu.cyclingcomputer.define.Units;
...
import static rnfive.htfu.cyclingcomputer.service.Service_Recording.START_RECORDING;
import static rnfive.htfu.cyclingcomputer.service.Service_Recording.STOP_RECORDING;
import static rnfive.htfu.cyclingcomputer.service.Service_Recording.ZERO_POWER;
...
import static rnfive.htfu.cyclingcomputer.service.Service_Recording.serviceRunning;
import static rnfive.htfu.cyclingcomputer.service.Service_StravaUpload.START_UPLOAD;
import static rnfive.htfu.cyclingcomputer.utils.MenuUtil.menuItemSelector;
...
public class MainActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ConstraintLayout main = findViewById(R.id.main_container);
    ...
    private void getPreferences(boolean load) {
        if (load)
    ...
    public void startUploadService() {
        Intent serviceIntent = new Intent(this, Service_StravaUpload.class);
    ...
    private void refreshToken() {
        if (token != null) {
            if (token.getExpirationDate() < Instant.now().toEpochMilli()) {
    ...
    protected void onStart() {
        ...
        Permissions.checkAppPermissions(this, this);
        //requestLocation(0);
