...
import rnfive.htfu.ant.antplus.pccbase.AntPlusLegacyCommonPcc;
import rnfive.htfu.ant.antplus.pccbase.AsyncScanController;
import rnfive.htfu.ant.antplus.pccbase.PccReleaseHandle;
import rnfive.htfu.ant.antplus.pccbase.AsyncScanController.IAsyncScanResultReceiver;
import rnfive.htfu.ant.internal.compatibility.LegacyHeartRateCompat;
...
public class AntPlusHeartRatePcc extends AntPlusLegacyCommonPcc {
    ...
    protected Intent getServiceBindIntent() {
        ...
        it.setComponent(new ComponentName("rn5.htfu.ant.antplus", "rn5.htfu.ant.antplus.heartrate.HeartRateService"));
        return it;
    }
    ...
    public static final class IpcDefines {
        public static final String PATH_ANTPLUS_HEARTRATEPLUGIN_PKG = "rn5.htfu.ant.antplus";
        public static final String PATH_ANTPLUS_HEARTRATEPLUGIN_SERVICE = "rn5.htfu.ant.antplus.heartrate.HeartRateService";
