...
public class MultiDeviceSearch {
    ...
    private static class SearchPcc extends AntPluginPcc {
        ...
        protected void handlePluginEvent(Message eventMsg) {
            ...
            switch(eventMsg.arg1) {
                case 1:
                    b = eventMsg.getData();
                    b.setClassLoader(rnfive.djs.ant.antplus.pccbase.MultiDeviceSearch.MultiDeviceSearchResult.class.getClassLoader());
                    rnfive.djs.ant.antplus.pccbase.MultiDeviceSearch.MultiDeviceSearchResult info = (rnfive.djs.ant.antplus.pccbase.MultiDeviceSearch.MultiDeviceSearchResult)b.getParcelable("dev_Device");
    ...
    public interface SearchCallbacks {
        ...
        void onDeviceFound(rnfive.djs.ant.antplus.pccbase.MultiDeviceSearch.MultiDeviceSearchResult var1);
